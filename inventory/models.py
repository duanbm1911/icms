...
class DeviceInterface(models.Model):
    ...
    device_ip = models.ForeignKey('Device', on_delete=models.CASCADE)
    list_interface_name = models.JSONField(max_length=10000, blank=True, null=True)
    list_interface_desc = models.JSONField(max_length=10000, blank=True, null=True)
    list_interface_speed = models.JSONField(max_length=10000, blank=True, null=True)
    list_interface_type = models.JSONField(max_length=10000, blank=True, null=True)
    list_interface_state = models.JSONField(max_length=10000, blank=True, null=True)
    user_created = models.CharField(max_length=10000, blank=True, null=True)
