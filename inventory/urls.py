...
urlpatterns = [
    ...
    path('create-device', DeviceBaseInfoCreateView.as_view()),
    ...
    path('update-device/<int:pk>', DeviceBaseInfoUpdateView.as_view()),
    path('detail-device/<int:pk>', DeviceBaseInfoDetailView.as_view()),
    path('delete-device/<int:pk>', DeviceBaseInfoDeleteView.as_view()),
    path('list-device', DeviceBaseInfoListView.as_view()),
