...
urlpatterns = [
    ...
    path('list-device-type', DeviceTypeListView.as_view()),
    path('list-device-type/update/<int:pk>', DeviceTypeUpdateView.as_view()),
    path('list-device-type/delete/<int:pk>', DeviceTypeDeleteView.as_view()),
    path('list-device-category', DeviceCategoryListView.as_view()),
    path('list-device-category/update/<int:pk>', DeviceCategoryUpdateView.as_view()),
    path('list-device-category/delete/<int:pk>', DeviceCategoryDeleteView.as_view()),
    path('list-device-vendor', DeviceVendorListView.as_view()),
    path('list-device-vendor/update/<int:pk>', DeviceVendorUpdateView.as_view()),
    path('list-device-vendor/delete/<int:pk>', DeviceVendorDeleteView.as_view()),
    ...
    path('list-device/device-topology/delete/<int:pk>', DeviceTopologyDeleteView.as_view()),
