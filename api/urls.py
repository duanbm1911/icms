...
urlpatterns = [
    ...
    path('inventory/get-list-device', views.get_list_device),
    path('inventory/update-device-check-config', views.update_device_check_config),
    path('inventory/update-device-check-monitor', views.update_device_check_monitor),
    path('inventory/update-device-firmware', views.update_device_firmware),
    path('inventory/update-device-interface', views.update_device_interface),
