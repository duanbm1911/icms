# Generated by Django 5.0.1 on 2024-06-26 07:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('irules', models.ManyToManyField(blank=True, to='cm.f5irule')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='waf_profile',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='cm.f5wafprofile'),
        ),
    ]
